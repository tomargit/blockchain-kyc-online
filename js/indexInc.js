...
alert("FirstAccount is"+firstAccount);
...
function onSignUp() {
    ...
    if (contractInstance.addBank.sendTransaction(bank_name1, pass, reg, {
        //from: web3.eth.accounts[0],
        from: firstAccount,
		gas: 4700000
    }) == 0){
    ...
    if (confirm(bank_name1 + " has been successfully added to the network!") == false) {
        window.location = '../html/indexOrganisationInc.html';
    }
...
function onLogin() {
    ...
    window.location = '../html/bankHomePage.html';
}